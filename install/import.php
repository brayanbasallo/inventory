...
if ($connection) {
    ...
    if ($connection->affected_rows > 0) {
        ...
        if ($connection) {
            ...
            $obj_insert->agregarUsuario($admin_document, $admin_user, $admin_name, $admin_password, 3, 111);
    ...
    echo json_encode(['status' => 500, "message" => "error de conexión con el servidor"]);
}
