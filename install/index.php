            ...
            <div class="col-12" v-if="!spinners">
                ...
                <div class="#" v-if="connection">
                    ...
                    <div class="form-group pt-1">
                        <button @click="connection = false" class="btn col-12 btn-primary btn-block">Continuar</button>
                    </div>
                </div>
                <div class="" v-else>
                    <span>Datos del usuario administrado</span>
                    <div class="form-group">
                        <label for="">Nombre</label>
                        <input v-model="model.admin_name" type="text" name="" class="form-control" placeholder="Nombre del usuario">
                    </div>
                    <div class="form-group">
                        <label for="">Usuario</label>
                        <input v-model="model.admin_user" type="text" name="" class="form-control" placeholder="Nombre de usuario">
                    </div>
                    <div class="form-group">
                        <label for="">Documento</label>
                        <input v-model="model.admin_document" type="text" name="" class="form-control" placeholder="Nombre de la base de datos">
                    </div>
                    <div class="form-group">
                        <label for="">Contraseña</label>
                        <input v-model="model.admin_password" type="password" name="" class="form-control" placeholder="Nombre de la base de datos">
                    </div>
                    <div class="form-group pt-1">
